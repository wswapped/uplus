				...
				if($status == 'Successfull')
				{
					...
					else
					{
						...
						if($success == true)
						{
							...
							$message    = 'Hi,'.$pushName.' '.$amount.' Rwf has been received by '.$pullName.' user with '.$pullNumber.', Intouch is the Uplus agent in MTN Mobile Money.';
							$data = array(
								"sender"		=>'UPLUS',
								"recipients"	=>$recipients,
								"message"		=>$message,
							...
							$message    = 'Hi, '.$pullName.' You have reived '.$amount.' Rwf from '.$pushName.' a uplus user with '.$pushNumber.', Intouch is the Uplus agent in MTN Mobile Money.';
							$data = array(
								"sender"		=>'UPLUS',
								"recipients"	=>$recipients,
								"message"		=>$message,
