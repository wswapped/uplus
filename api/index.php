...
{
	include("../db.php");
	$sqlgroups = $db->query("SELECT id AS groupId, groupName, targetAmount, perPerson, adminId, adminName, groupDesc FROM groups WHERE archive is null ORDER BY id DESC");
	$groups = array();
