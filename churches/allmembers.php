    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <div class="heading_a uk-grid uk-margin-bottom uk-grid-width-large-1-2">
                <div class="uk-row-first"><h4 class="">All members </h4><h3 class="status" id="status"></h3> <input type="file" name="file1" id="file1" onchange="uploadFile()" class="md-btn"></div>
                        ...
                        <div class="uk-modal" id="modal_upload_members" aria-hidden="true" style="display: none; overflow-y: auto;">
                            <div class="uk-modal-dialog" style="top: 339.5px;">
                                ...
                                <div class="md-card">
                                    ...
                                    <div class="md-card-content">
                                        <form id="memExport" action="api/index.php" method="POST" enctype="multipart/form-data" target="_blank">
                                            <div class="md-input-wrapper">
                                                ...
                                                <div class="dropify-wrapper">
                                                    ...
                                                    <input data-default-file="file:///C:/xampp/htdocs/uplus/churches/Church%20members.xlsx" name = "members-file" type="file" data-allowed-file-extensions="xls xlsx" id="member_upload_file" class="dropify">
									...
									while($rowMember = mysqli_fetch_array($sqlGetMembers))
										{
											...
											<td><a href="editmember.php?memberid='.$rowMember['id'].'"><i class="material-icons"></i></a></td>
											</tr>';
										}
									?> 
