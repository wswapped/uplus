...
?>
 	<div style=" background-size:300px 200px; width:300px;  height:200px;display:inline-block; float:left;  margin-right:3px;  margin-bottom:3px; border:1px solid #c0c0c0;background-image:url('images/<?php echo $event_cover; ?>'); ">
 		...
 		<a  style="text-decoration:none;" href="more.php?event=<?php echo $event_id; ?>"><div style="background:rgba(255,255,255,0.8);color:#000;  font-size:15px;border-top:1px solid #333; max-width:100%; height:50px;text-align:center;cursor:pointer;  font-weight:bold;" " >More</div></a>
 	</div>
<?php
}
 ?>
