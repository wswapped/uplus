<?php
	...
	$competion_start = "2018-03-17 00:00:00";
	$response = array();
	if($action ==  'get_groups'){
		...
		$sql = "SELECT COUNT(*) AS num, SUM(t.amount) as amount, g.groupName as name FROM rtgs.grouptransactions t JOIN uplus.groups g ON t.groupId = g.id WHERE t.status = 'Successfull' AND g.createdDate >= \"$competion_start\" GROUP BY g.id ORDER BY num DESC LIMIT 10 ";
		// echo $sql;
