<?php
	...
	if($action ==  'get_groups'){
		...
		$sql = "SELECT COUNT(*) AS num, SUM(t.amount) as amount, g.groupName as name FROM rtgs.grouptransactions t JOIN uplus.groups g ON t.groupId = g.id WHERE t.status = 'Successfull' GROUP BY g.id ORDER BY num DESC LIMTI 10 ";
		// echo $sql;
